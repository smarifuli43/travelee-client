      ...
      <div className='row align-items-center'>
        ...
        <div className='col-12 col-lg-6 mt-4 mt-lg-0'>
          <h5 className='mt-4 mt-lg-0'>
            Hello <span style={{ color: '#0791BE' }}>{user.displayName}! </span>book for your next tour
          </h5>
          <p>{description}</p>
          <h3>Travel info:</h3>
        ...
        <div className="col-12">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <input type='email' placeholder="Your Email" {...register('email', { required: true})} />
              ...
              <div className="col-12 col-md-6 col-lg-3">
           <input type='date' placeholder="Journey Date" {...register('date', { required: true})} />
              </div>
            </div>

        <input type='submit' className="btn-travelee text-uppercase" value="Book now" style={{width:'150px'}} />
        </form>
       </ div>
     </div>
    </div>
